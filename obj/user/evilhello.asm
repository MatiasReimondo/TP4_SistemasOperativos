...
umain(int argc, char **argv)
{
  ...
  800040:	e8 b3 00 00 00       	call   8000f8 <sys_cputs>
}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000dd:	50                   	push   %eax
  8000de:	52                   	push   %edx
  8000df:	68 4a 1d 80 00       	push   $0x801d4a
  8000e4:	6a 23                	push   $0x23
  8000e6:	68 67 1d 80 00       	push   $0x801d67
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8003a2:	ba f4 1d 80 00       	mov    $0x801df4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8003cd:	51                   	push   %ecx
  8003ce:	50                   	push   %eax
  8003cf:	68 78 1d 80 00       	push   $0x801d78
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8005f6:	53                   	push   %ebx
  8005f7:	50                   	push   %eax
  8005f8:	68 b9 1d 80 00       	push   $0x801db9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8006cb:	53                   	push   %ebx
  8006cc:	50                   	push   %eax
  8006cd:	68 d5 1d 80 00       	push   $0x801dd5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800780:	53                   	push   %ebx
  800781:	50                   	push   %eax
  800782:	68 98 1d 80 00       	push   $0x801d98
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a06:	68 04 1e 80 00       	push   $0x801e04
  800a0b:	68 0b 1e 80 00       	push   $0x801e0b
  800a10:	6a 7c                	push   $0x7c
  800a12:	68 20 1e 80 00       	push   $0x801e20
  800a17:	e8 bd 05 00 00       	call   800fd9 <_panic>
	assert(r <= PGSIZE);
  800a1c:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a21:	7e 16                	jle    800a39 <devfile_read+0x65>
  800a23:	68 2b 1e 80 00       	push   $0x801e2b
  800a28:	68 0b 1e 80 00       	push   $0x801e0b
  800a2d:	6a 7d                	push   $0x7d
  800a2f:	68 20 1e 80 00       	push   $0x801e20
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b12:	68 37 1e 80 00       	push   $0x801e37
  800b17:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bc2:	50                   	push   %eax
  800bc3:	56                   	push   %esi
  800bc4:	68 3e 1e 80 00       	push   $0x801e3e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e66:	68 56 1e 80 00       	push   $0x801e56
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ff5:	56                   	push   %esi
  800ff6:	50                   	push   %eax
  800ff7:	68 64 1e 80 00       	push   $0x801e64
  ...
  801008:	e8 54 00 00 00       	call   801061 <vcprintf>
	cprintf("\n");
  80100d:	c7 04 24 4f 1e 80 00 	movl   $0x801e4f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801160:	0f be 80 87 1e 80 00 	movsbl 0x801e87(%eax),%eax
  801167:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80135d:	50                   	push   %eax
  80135e:	68 9f 1e 80 00       	push   $0x801e9f
  801363:	53                   	push   %ebx
  801364:	56                   	push   %esi
  ...
  801375:	52                   	push   %edx
  801376:	68 1d 1e 80 00       	push   $0x801e1d
  80137b:	53                   	push   %ebx
  80137c:	56                   	push   %esi
  ...
  80139a:	b8 98 1e 80 00       	mov    $0x801e98,%eax
