	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f3:	0f be 80 68 1d 80 00 	movsbl 0x801d68(%eax),%eax
  8001fa:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800321:	ff 24 85 a0 1e 80 00 	jmp    *0x801ea0(,%eax,4)
  ...
  8003e5:	8b 14 85 00 20 80 00 	mov    0x802000(,%eax,4),%edx
  8003ec:	85 d2                	test   %edx,%edx
  8003ee:	75 18                	jne    800408 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003f0:	50                   	push   %eax
  8003f1:	68 80 1d 80 00       	push   $0x801d80
  8003f6:	53                   	push   %ebx
  8003f7:	56                   	push   %esi
  ...
  800408:	52                   	push   %edx
  800409:	68 31 21 80 00       	push   $0x802131
  80040e:	53                   	push   %ebx
  80040f:	56                   	push   %esi
  ...
  80042d:	b8 79 1d 80 00       	mov    $0x801d79,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a2e:	50                   	push   %eax
  800a2f:	52                   	push   %edx
  800a30:	68 5f 20 80 00       	push   $0x80205f
  800a35:	6a 23                	push   $0x23
  800a37:	68 7c 20 80 00       	push   $0x80207c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800cf3:	ba 08 21 80 00       	mov    $0x802108,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d1e:	51                   	push   %ecx
  800d1f:	50                   	push   %eax
  800d20:	68 8c 20 80 00       	push   $0x80208c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800f47:	53                   	push   %ebx
  800f48:	50                   	push   %eax
  800f49:	68 cd 20 80 00       	push   $0x8020cd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80101c:	53                   	push   %ebx
  80101d:	50                   	push   %eax
  80101e:	68 e9 20 80 00       	push   $0x8020e9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8010d1:	53                   	push   %ebx
  8010d2:	50                   	push   %eax
  8010d3:	68 ac 20 80 00       	push   $0x8020ac
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801357:	68 18 21 80 00       	push   $0x802118
  80135c:	68 1f 21 80 00       	push   $0x80211f
  801361:	6a 7c                	push   $0x7c
  801363:	68 34 21 80 00       	push   $0x802134
  801368:	e8 bd 05 00 00       	call   80192a <_panic>
	assert(r <= PGSIZE);
  80136d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801372:	7e 16                	jle    80138a <devfile_read+0x65>
  801374:	68 3f 21 80 00       	push   $0x80213f
  801379:	68 1f 21 80 00       	push   $0x80211f
  80137e:	6a 7d                	push   $0x7d
  801380:	68 34 21 80 00       	push   $0x802134
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801463:	68 4b 21 80 00       	push   $0x80214b
  801468:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801513:	50                   	push   %eax
  801514:	56                   	push   %esi
  801515:	68 52 21 80 00       	push   $0x802152
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017b7:	68 6a 21 80 00       	push   $0x80216a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801946:	56                   	push   %esi
  801947:	50                   	push   %eax
  801948:	68 78 21 80 00       	push   $0x802178
  ...
  801959:	e8 96 e7 ff ff       	call   8000f4 <vcprintf>
	cprintf("\n");
  80195e:	c7 04 24 5c 1d 80 00 	movl   $0x801d5c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8019fe:	50                   	push   %eax
  8019ff:	68 9c 21 80 00       	push   $0x80219c
  801a04:	6a 42                	push   $0x42
  801a06:	68 b2 21 80 00       	push   $0x8021b2
