...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 86 23 80 00       	push   $0x802386
  80006d:	6a 09                	push   $0x9
  80006f:	68 a0 23 80 00       	push   $0x8023a0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000fb:	56                   	push   %esi
  8000fc:	50                   	push   %eax
  8000fd:	68 c0 23 80 00       	push   $0x8023c0
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800463:	50                   	push   %eax
  800464:	68 fb 23 80 00       	push   $0x8023fb
  800469:	53                   	push   %ebx
  80046a:	56                   	push   %esi
  ...
  8004a0:	b8 f4 23 80 00       	mov    $0x8023f4,%eax
